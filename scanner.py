...
def main(url):
	try:
		...
		get_jembut = requests.get(url+'/kcfinder/upload.php',headers=headers,timeout=15).content
		if 'alert("Unknown error");' in get_jembut:
...
if __name__ == '__main__':
 ...
 |_|\_\____|_|   |___|_| \_|____/|_____|_| \_\
	...
	SCANNER \033[32;1mKCFINDER VULN\033[0m by 0x1337 \n""")
	try:
		lists = sys.argv[1]
